...
bytes_read_total = Counter(
    'dfs_bytes_read_total',
    'Total bytes read',
    registry=registry
)

bytes_written_total = Counter(
    'dfs_bytes_written_total',
    'Total bytes written',
    registry=registry
)
...
heartbeat_sent_total = Counter(
    'dfs_heartbeat_sent_total',
    'Total heartbeats sent',
    registry=registry
)

heartbeat_failed_total = Counter(
    'dfs_heartbeat_failed_total',
